<?php
     ...
     * @brief  pxeboard 모듈의 View Action에 대한 API 처리
     **/

    class pxeboardAPI extends pxeboard {

/* dispPxeboardContent 는 사용하지 않는다..
        function dispPxeboardContent(&$oModule) {
        }
*/
         ...
         * @brief 공지사항 목록
         **/
        function dispPxeboardNoticeList(&$oModule) {
         ...
         * @brief 컨텐츠 목록
         **/
        function dispPxeboardContentList(&$oModule) {
         ...
         * @brief 카테고리(분류) 목록
         **/
        function dispPxeboardCatogoryList(&$oModule) {
         ...
         * @brief 게시물 보기
         **/
        function dispPxeboardContentView(&$oModule) {
         ...
         * @brief 컨텐츠의 파일 목록
         **/
        function dispPxeboardContentFileList(&$oModule) {
         ...
         * @brief 태그 목록
         **/
        function dispPxeboardTagList(&$oModule) {
         ...
         * @brief 컨텐츠의 코멘트 목록
         **/
        function dispPxeboardContentCommentList(&$oModule) {
            $oModule->add('comment_list',$this->arrangeComment(Context::get('comment_list')));
        }

        /**
         * @brief record reader rating
         **/
        function dispPxeboardReaderRating(&$oModule) {
            $oModule->add('reader_rating_average', Context::get('reader_rating_average'));
            $oModule->add('reader_rating_count', Context::get('reader_rating_count'));
        }
