...
function completeInsertBoard(ret_obj) {
    ...
    var url = current_url.setQuery('act','dispPxeboardAdminBoardInfo');
...
function completeDeleteBoard(ret_obj) {
    ...
    var url = current_url.setQuery('act','dispPxeboardAdminContent').setQuery('module_srl','');
...
function completeUpdateCategory(ret_obj) {
    ...
    var url = current_url.setQuery('module_srl',module_srl).setQuery('act','dispPxeboardAdminCategoryInfo');
    if(page) url.setQuery('page',page);
    location.href = url;
}
...
function doSaveListConfig(module_srl) {
    ...
    exec_xml('pxeboard','procPxeboardAdminInsertListConfig', params, function() { location.reload(); });
}
