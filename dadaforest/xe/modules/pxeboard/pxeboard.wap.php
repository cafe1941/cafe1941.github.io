<?php
     ...
     * @brief  pxeboard 모듈의 WAP class
     **/

    class pxeboardWAP extends pxeboard {
        ...
        function procWAP(&$oMobile) {
            ...
            if($document_srl) {
                ...
                if($oDocument->isExists()) {
                    ...
                    // 댓글 보기 일 경우
                    if($this->act=='dispPxeboardContentCommentList') {
                    ...
                    // 댓글 보기가 아니면 글 보여줌
                        ...
                        $content = Context::getLang('replies').' : <a href="'.getUrl('act','dispPxeboardContentCommentList').'">'.$oDocument->getCommentCount().'</a><br>'."\r\n".$content;
